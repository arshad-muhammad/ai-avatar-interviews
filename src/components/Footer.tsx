    ...
    <footer className="bg-gray-50 py-12 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4 text-brand-blue">InterviewAI</h3>
            <p className="text-gray-600 mb-4">
              Revolutionizing HR interviews with AI-powered 3D avatar interviewers.
            </p>
          </div>
          
          <div>
            <h4 className="font-medium mb-4 text-gray-800">Product</h4>
            <ul className="space-y-2">
              <li><Link to="/features" className="text-gray-600 hover:text-brand-blue">Features</Link></li>
              <li><Link to="/pricing" className="text-gray-600 hover:text-brand-blue">Pricing</Link></li>
              <li><Link to="/demo" className="text-gray-600 hover:text-brand-blue">Request Demo</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/guides" className="text-gray-600 hover:text-brand-blue">Guides</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 mb-4 md:mb-0">© {new Date().getFullYear()} InterviewAI. All rights reserved.</p>
